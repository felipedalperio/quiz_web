...
export default class QuestaoModel{
        ...
        embaralharRespostas() : QuestaoModel{
            let respostasEmbraralhadas = embaralhar(this.#respostas)
            return new QuestaoModel(this.#id,this.#enunciado, respostasEmbraralhadas,this.#acertou)
        }

        static criarUsandoObjeto(obj: QuestaoModel) : QuestaoModel{
            //convertendo as respostas que recebi:
